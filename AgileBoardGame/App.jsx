...
class App extends React.Component {
    ...
    endGame() {
        ...
        if(this.state.playerName != null) {
            ...
            axios.post('http://localhost:80/AgileBoardGame/api/api.php',
             querystring.stringify({teamName: this.state.playerName, score: this.state.earnings,
              wastedPoints: this.state.wastedPoints, cardsDone: cardsDone.length}))
        }
    }
