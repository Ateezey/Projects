<div id="content">
	...
	<h2>Vʌ  Vʌ</h2>
	<hr>
	<iframe class ="vid" src="https://www.youtube.com/embed/Dkm8Hteeh6M" frameborder="0" allowfullscreen></iframe>
  ...
  (function(e){
	...
	$(document).ready(function(){
		...
		//
		$("#countdown").countdown({
			date: "17 January 2018 23:59:59", // change date/time here - do not change the format!
			format: "on"
		});

		$("#countdown1").countdown({
			date: "20 June 2018 23:59:59", // change date/time here - do not change the format!
			format: "on"
		});
	});
});
